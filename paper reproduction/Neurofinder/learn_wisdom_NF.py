...
Dimens = [(504,504), (504,504), (504,504), (464,504), (416,480)] # lateral dimension of the video
list_nframes = [2250, 1825, 5000, 8000, 3000]
...
for ind_video in range(0,len(Dimens)): # 
    ...
    nn = list_nframes[ind_video] ## "nn" slightly larger than "Nframe" is fine
