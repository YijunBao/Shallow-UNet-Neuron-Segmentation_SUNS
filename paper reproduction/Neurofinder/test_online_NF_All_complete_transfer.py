...
if __name__ == '__main__':
    ...
    for trainset_type in {'train'}: # , 'test'
        ...
        dir_output = dir_parent + 'transfer\\output_masks online update\\' # folder to save the segmented masks and the performance scores
        dir_params = dir_parent_train + 'transfer\\output_masks\\' # folder of the optimized hyper-parameters
        weights_path = dir_parent_train + 'transfer\\Weights\\' # folder of the trained CNN
