...
if __name__ == '__main__':
    ...
    num_train_per = 300 # Number of frames per video used for training 
    ...
    for trainset_type in {'train', 'test'}: # 
        ...
        dir_video = 'E:\\NeuroFinder\\bin3\\{} videos\\'.format(trainset_type)
        ...
        results = train_CNN(dir_network_input, dir_mask, file_CNN, list_Exp_ID_train, list_Exp_ID_val, \
            BATCH_SIZE, NO_OF_EPOCHS, num_train_per, num_total, Params_loss, exist_model)
        ...
        parameter_optimization_cross_validation(cross_validation, list_Exp_ID, Params_set, list_Mag, \
            Dimens, Dimens, dir_network_input, weights_path, dir_GTMasks, dir_temp, dir_output, \
