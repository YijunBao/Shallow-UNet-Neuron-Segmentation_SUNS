...
if __name__ == '__main__':
    ...
    for trainset_type in {'train', 'test'}: # 
        ...
        dir_parent = dir_video + 'expTF\\' # folder to save all the processed data
        dir_parent_train = dir_video_train + 'noSFexpTF\\' # folder to save all the processed data
        ...
        for (ind_video, Exp_ID) in enumerate(list_Exp_ID): # 
            ...
            if useTF:
                ...
                # Poisson_filt = np.ones(60).astype('float32')/60
                decay = 0.8
