...
from suns.run_suns_video import suns_online_track
...
if __name__ == '__main__':
    ...
    dir_output = os.path.join(dir_parent, 'output_masks track video') # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, list_time_per, list_Masks_cons_2D, list_active_old = suns_online_track(
        ...
        savemat(os.path.join(dir_output, 'Output_Masks_{}.mat'.format(Exp_ID)), {'Masks':Masks, 'list_time_per':list_time_per,\
            'list_Masks_cons_2D': list_Masks_cons_2D, 'list_active_old':list_active_old}, do_compression=True)
