...
if __name__ == '__main__':
    ...
    list_num_train = [12, 2, 2, 1, 1, 1] 
    list_Exp_ID_full = [['00.00', '00.01'], ['01.00', '01.01'], \
                        ['02.00', '02.01'], ['03.00'], ['04.00'], ['05.00']] 
    ...
    for ind_set in [0,1,2,3,4,5]: # [4]: # 
        ...
        dir_train = 'E:\\NeuroFinder\\web\\train videos\\' + list_Exp_ID[0][:2]
        dir_video = 'E:\\NeuroFinder\\web\\test videos\\' + list_Exp_ID[0][:2]
        ...
        dir_parent = os.path.join(dir_video, 'complete\\trial 1') # folder to save all the processed data
        dir_parent_train = os.path.join(dir_train, 'complete\\trial 1') # folder to save all the processed data
        ...
        for CV in list_CV:
            ...
            print('Video ', Exp_ID)
            filename_CNN = os.path.join(weights_path, 'Model_CV{}.h5'.format(list_num_train[ind_set])) # The path of the CNN model.

            # load optimal post-processing parameters
            Optimization_Info = loadmat(os.path.join(dir_params, 'Optimization_Info_{}.mat'.format(list_num_train[ind_set])))
