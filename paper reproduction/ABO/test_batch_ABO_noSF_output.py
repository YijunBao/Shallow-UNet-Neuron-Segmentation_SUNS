...
from suns.run_suns_output import suns_batch
...
if __name__ == '__main__':
    ...
    dir_output = dir_parent + 'output_masks output\\' # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, times_cons = suns_batch(
        ...
        savemat(dir_output+'Output_Masks_{}.mat'.format(Exp_ID), {'Masks_2':Masks_2, 'times_cons':times_cons})
