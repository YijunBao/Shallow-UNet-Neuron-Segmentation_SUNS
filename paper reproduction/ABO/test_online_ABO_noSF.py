...
if __name__ == '__main__':
    ...
    dir_parent = dir_video + 'noSF\\1skip SNR=6\\' # folder to save all the processed data
    dir_output = dir_parent + 'output_masks online update_v1\\' # folder to save the segmented masks and the performance scores
