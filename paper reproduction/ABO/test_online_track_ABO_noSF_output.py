...
from suns.run_suns_output import suns_online_track
...
if __name__ == '__main__':
    ...
    batch_size_init = 10 # batch size in CNN inference during initalization

    dir_parent = dir_video + 'noSF\\' # folder to save all the processed data
    dir_output = dir_parent + 'output_masks track output\\' # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, list_time_per, times_cons = suns_online_track(
        ...
        savemat(dir_output+'Output_Masks_{}.mat'.format(Exp_ID), {'Masks_2':Masks_2, \
            'list_time_per':list_time_per, 'times_cons':times_cons})
