...
REM python test_batch_ABO_1to9_complete.py 0
REM python test_batch_ABO_1to9_complete.py 1
REM python test_batch_ABO_1to9_complete.py 2
REM python test_batch_ABO_1to9_complete.py 3
REM python test_batch_ABO_1to9_complete.py 4
REM python test_batch_ABO_1to9_complete.py 5
REM python test_batch_ABO_1to9_complete.py 6
REM python test_batch_ABO_1to9_complete.py 7
REM python test_batch_ABO_1to9_complete.py 8
REM python test_batch_ABO_1to9_complete.py 9
