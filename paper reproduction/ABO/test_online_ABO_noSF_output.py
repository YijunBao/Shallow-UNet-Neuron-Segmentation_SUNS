...
from suns.run_suns_output import suns_online
...
if __name__ == '__main__':
    ...
    dir_output = dir_parent + 'output_masks online output\\' # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, list_time_per, times_cons = suns_online(
        ...
        savemat(dir_output+'Output_Masks_{}.mat'.format(Exp_ID), {'Masks_2':Masks_2, \
            'list_time_per':list_time_per, 'times_cons':times_cons}, do_compression=False)
