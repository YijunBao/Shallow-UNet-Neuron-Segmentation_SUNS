...
from suns.run_suns_test_merge import suns_batch
...
if __name__ == '__main__':
    ...
    dir_output = dir_parent + 'output_masks test_merge\\' # folder to save the segmented masks and the performance scores
    ...
    for CV in [2]: # list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, segs = suns_batch(
        ...
        # savemat(dir_output+'segs_{}.mat'.format(Exp_ID), {'segs':segs}, do_compression=True)
        ...
        savemat(dir_output+'segs_{}.mat'.format(Exp_ID), {'totalmasks':totalmasks, 'neuronstate':neuronstate, \
            'COMs':COMs, 'areas':areas, 'probmapID':probmapID}, do_compression=True)
