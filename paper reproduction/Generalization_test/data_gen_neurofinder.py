...
# %% Generator of training images from non-square dataset
def data_gen_rectangle(train_img, train_mask, batch_size, flips=False, rotate=False): 
...
# %% Generator of training images from datasets with different sizes
def data_gen_different_size(list_train_img, list_train_mask, batch_size, flips=False, rotate=False): 
    print('flips = {}, rotate = {}'.format(flips, rotate))
