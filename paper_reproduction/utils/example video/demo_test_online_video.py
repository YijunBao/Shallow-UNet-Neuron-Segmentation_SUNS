...
from suns.run_suns_video import suns_online
...
if __name__ == '__main__':
    ...
    dir_output = os.path.join(dir_parent, 'output_masks online video') # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, time_total, time_frame, list_time_per, list_Masks_2 = suns_online(
        ...
        savemat(os.path.join(dir_output, 'Output_Masks_{}.mat'.format(Exp_ID)), \
            {'Masks':Masks, 'list_Masks_2':list_Masks_2, 'list_time_per':list_time_per}, do_compression=True)
