...
REM python test_online_NF_noSF_2skip.py
REM python test_online_NF_noSF_2skip_update.py
python train_CNN_params_NF_noSF_vary_CNN.py 3 4 [1,2] elu True 2skip_1 0 noSF
python test_batch_NF_noSF_vary_CNN.py 3 4 [1,2] elu True 2skip_1 0 noSF
python test_online_NF_noSF_2skip.py
python test_online_NF_noSF_2skip_update.py
python train_CNN_params_NF_noSF_vary_CNN.py 3 4 [1,2] elu True 2skip_1 1 noSF_subtract
python test_batch_NF_noSF_vary_CNN.py 3 4 [1,2] elu True 2skip_1 1 noSF_subtract
python test_online_NF_noSF_2skip_copy.py
python test_online_NF_noSF_2skip_update_copy.py
