...
if __name__ == '__main__':
    ...
    med_subtract = bool(int(sys.argv[7]))
    folder = sys.argv[8]
    ...
    for trainset_type in {'train', 'test'}: # 
        ...
        dir_parent = dir_video + folder + '\\' # folder to save all the processed data
        dir_parent_train = dir_video_train + folder + '\\' # folder to save all the processed data
        dir_sub = 'test_CNN\\' + sub_folder + '\\'
