...
def get_unet(): #(size)
    ...
    c1 = tf.keras.layers.Conv2D(2, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(inputs)
    ...
    #                             padding='same')(p1)
    c2 = tf.keras.layers.Conv2D(4, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(p1)
    ...
    #                             padding='same')(p2)
    c3 = tf.keras.layers.Conv2D(8, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(p2)
    ...
    c4 = tf.keras.layers.Conv2D(16, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                               padding='same')(p3)
    ...
    c6 = tf.keras.layers.Conv2D(16, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                               padding='same')(c4)
    ...
    c7 = tf.keras.layers.Conv2D(8, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(u7)
    c7 = tf.keras.layers.Dropout(0.2)(c7)
    #c7 = tf.keras.layers.Conv2D(16, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
    #                            padding='same')(c7)

    u8 = tf.keras.layers.Conv2DTranspose(4, (2, 2), strides=(2, 2), padding='same')(c7)
    # u8 = tf.keras.layers.concatenate([u8, c2], axis=3)
    c8 = tf.keras.layers.Conv2D(4, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(u8)
    c8 = tf.keras.layers.Dropout(0.1)(c8)
    #c8 = tf.keras.layers.Conv2D(8, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
    #                            padding='same')(c8)

    u9 = tf.keras.layers.Conv2DTranspose(2, (2, 2), strides=(2, 2), padding='same')(c8)
    u9 = tf.keras.layers.concatenate([u9, c1], axis=3)
    c9 = tf.keras.layers.Conv2D(2, (3, 3), activation=tf.keras.activations.elu, kernel_initializer='he_normal',
                                padding='same')(u9)
