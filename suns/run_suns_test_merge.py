...
from suns.PostProcessing.complete_post_test_merge import complete_segment
...
def suns_batch(dir_video, Exp_ID, filename_CNN, Params_pre, Params_post, dims, \
    ...
    Masks_2, segs = complete_segment(pmaps_b, Params_post_copy, display=display, p=p, useWT=useWT)
    if display:
        finish = time.time()
    ...
    return Masks, Masks_2, time_total, time_frame, segs
