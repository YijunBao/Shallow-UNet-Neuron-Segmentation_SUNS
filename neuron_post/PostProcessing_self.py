...
if __name__ == '__main__':
    ...
    list_thresh_pmap = list(range(10,255,10)) # + list(range(246,255,2)) # [234] # 
    thresh_mask = 0.5
    thresh_COM0 = 2
...
# %%
    for CV in range(10): # list(range(0,6))+list(range(7,10)): #
        ...
        Recall_train = list_Recall
        Precision_train = list_Precision
        F1_train = list_F1
        print('F1_max=', list_F1.max())
        ind = list_F1.argmax()
        ...
        savemat(dir_output+'Optimization_Info_self_{}.mat'.format(Exp_ID), Info_dict)
        ...
        savemat(dir_output+'Output_Info_self_{}.mat'.format(Exp_ID), Info_dict)
        savemat(dir_output+'Output_Masks_self_{}.mat'.format(Exp_ID), {'Masks_2':Masks_2})
